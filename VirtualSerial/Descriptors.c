...
// device enumeration, tho determine the device's capabilities and functions.
...
// describes the overall device characters, including the supported USB version,
// control endpoint size and the number of device configurations. The descriptor
// is read out by the USB host when the enumeration process begins.
...
// can be passed back and the appropriate descriptor send back to the USB host.
