...
// HID class descriptor. This is a special descriptor constructed with values
// from the USBIF HID class specification to describe the reports and capabilities
// of the HID device. This descriptor is parsed by the host and its contents
// used to determine what data (and in what encoding) the device will send,
// and what it may be sent back from the host. Refer to the HID specification
...
// describes the overall device characteristic, including the supported USB
...
// language ID table available at USB.org what languages the device supports
// for its string descriptors.
const USB_Descriptor_String_t PROGMEM LanguageString = USB_STRING_DESCRIPTOR_ARRAY(LANGUAGE_ID_ENG);

// Manufacture descriptor string. This is a Unicode string containing the
...
// to the USB library. When the device receives a Get Descriptor request on the
